...
function updateStatusBarTheme() {
    ...
    if (statusBarMeta) {
        // Use 'light-content' for dark theme (light text/icons)
        // Use 'dark-content' for light theme (dark text/icons)
        statusBarMeta.content = theme === 'dark' ? 'light-content' : 'dark-content';
    }
}
